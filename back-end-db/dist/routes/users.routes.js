...
var ChangeUserAvatarService_1 = __importDefault(require("../services/ChangeUserAvatarService"));
...
usersRouter.patch('/avatar', ensureAuthenticated_1.default, upload.single('avatar'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var changeUserAvatar, user, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                changeUserAvatar = new ChangeUserAvatarService_1.default();
                return [4 /*yield*/, changeUserAvatar.execute({
                        //@ts-ignore
